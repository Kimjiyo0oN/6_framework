...
public class AjaxController {
	...
	@ResponseBody // 반환된 값을 jsp 경로가 아닌 값 자체로 인식 (web-inf/main/.jsp)이런게 아닌 값
	...
	// {"memberEmail" : member.getMemberEmail(),"memberNcikname": member.getMemberNickname()} 
